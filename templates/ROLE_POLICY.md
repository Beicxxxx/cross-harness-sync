...
> Adopted: <YYYY-MM-DD HH:MM:SS> (<timezone>), by <who>.
...
<List standing prohibitions, e.g. "X remains DO NOT ADVANCE; only the user lifts
it." Delete this section if the project has none.>
